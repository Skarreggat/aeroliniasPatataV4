...
public class FormAvio {
	 ...
	 * 
	 * - Heu d'inicialitzar l'objecte JFrame amb títol "Formulari Avió" i layout
	 * Grid d'una columna - Heu d'inicialitzar els objectes JLabel amb el nom
	 * corresponent segons l'atribut de l'avió que representen. - Heu d'inicialitzar
	 * els objectes JTextField amb una longitud de 20 caràcters. - Heu
	 * d'inicialitzar els objectes JButton amb els noms "Desar" i "Sortir"
	 * respectivament. - Heu d'afegir-ho tot a l'atribut frame - Heu de fer visible
	 * el frame amb l'amplada i alçada que proposen els atributs alcada i amplada -
	 * Heu de fer que la finestra es tanqui quan l'usuari ho fa amb el control "X"
	 * de la finestra
	 * 
	 */
	public FormAvio() {
	...
	/*
	 * CONSTRUCTOR Paràmetres: valors del codi, fabricant, model i capacitat
	 * Accions: - Crear un formulari amb l'atra constructor d'aquesta classe
	 * FormAvio(). - Mostrar els valors passats per paràmetre en els camps de text
	 * pertinents del formulari.
	 */
