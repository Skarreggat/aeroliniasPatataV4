...
public class ControladorPrincipal implements ActionListener {
	...
	public static final String M_SORTIR = "0. Sortir";
	public static final String M_COMPANYIA = "1. Menú Companyia";
	public static final String M_AVIO = "2. Menu Avió";

	/*
	 * CONSTRUCTOR Paràmetres:cap Accions: - S'inicialitza l'atribut menuPrincipal
	 * (això mostrarà el menú principal) - A cada botó del menú principal se li
	 * afegeix el listener tenint en compte què el mètode actionPerformed, està
	 * implementat en aquesta classe.
	 */
	...
	/*
	 * Paràmetres: ActionEvent Acció: S'ha de cridar a seleccionarOpcio segons
	 * l'opció premuda. Penseu que l'opció es correspon amb la posició que el botó
	 * ocupa a l'array de botons de menuPrincipal. Retorn: cap
	 */
	...
	private void seleccionarOpcio(int opcio) {
		...
		case 2: // Gestió avió
			if (companyiaActual != null) {
				...
				JOptionPane.showMessageDialog(null, "Has de seleccionar una companyia al menu companyia.", "Avís",
